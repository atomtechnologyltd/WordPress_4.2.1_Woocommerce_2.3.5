  ...
  // Build the administration fields for this specific Gateway
	...
	$atom_login_id 	= $this->login_id;
	   ...
	   global $wpdb, $woocommerce;
		...
		$this->redirect_to_atom($q);
		?>
		
		<!--script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
        <form id='atompaynetz_form' name='atompaynetz_form' action='<?php echo $q?>' method='post'>
			<input type='submit' id="verify"  value='continue to atompaynetz'/>
        </form-->
	...
	// Redirect to AOM Bank list page
	function redirect_to_atom($url){
			   ?>
